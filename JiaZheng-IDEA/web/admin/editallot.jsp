				...
				<div class="col-md-6 col-md-offset-3">
					<div id="myTabContent" class="tab-content">
						<form action="allot/updateAllot.action" name="myform" method="post" onsubmit="return check()" class="form">
							...
							<div>
								<input type="hidden" name="allotid" id="allotid" value="${allot.allotid}" /><input type="hidden" name="addtime"
									id="addtime" value="${allot.addtime}" /> <input type="hidden" name="status" id="status"
									value="${allot.status}" />
